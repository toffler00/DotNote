//
//  DiaryWithoutImageCell.swift
//  Orbit
//
//  Created by ilhan won on 09/04/2019.
//  Copyright © 2019 orbit. All rights reserved.
//

import UIKit

class DiaryWithoutImageCell: UICollectionViewCell {
    ...
    func setUpLayout() {
        ...
        contentsImg.heightAnchor.constraint(equalToConstant: 1).isActive = true
